<?php
/**
 * Repopulate Standard Metrics
 */

require_once __DIR__ . '/db.php';

// Direct connection to avoid any class ambiguity
$mysqli = new mysqli('localhost', 'jigsaw', 'Jigsaw1', 'monitoring_system');
if ($mysqli->connect_error) die("Connection failed: " . $mysqli->connect_error);

echo "Starting Metric Population...\n";
...
$standardMetrics = [
    ...
    ['app.jams.version', 'JAMS Version', 'Versión del software JAMS instalada'],
...
$count = $mysqli->query("SELECT count(*) as c FROM metrics")->fetch_assoc()['c'];
echo "Population Complete. Total Metrics: $count\n";

// 2. Clear Template Assignments and Re-assign (Just to be sure)
...
$templates = [
    'FMS' => [
        ...
        'backup.daily.file', 'backup.hourly.file', 'app.fms.version', 'app.jams.version'
    ],
    'OAS' => [
        'system.cpu.load', 'system.ram.percent', 'system.disk.usage',
