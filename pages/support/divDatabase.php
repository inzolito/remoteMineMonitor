    ...
    <div class="col-md-12">
        <div class='<?php echo $colorbordeT ?>'>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-3"><i class='fa-solid  fa-server'></i> server 1<?php echo $system->validarLog($tamanoBdPrimarioL, 8) ?></div>
                    <div class="col-md-3"><i class='fa-solid  fa-server'></i> server 1<?php echo $system->validarLog($sqlSizePrimario, 8) ?></div>
                    <div class="col-md-3"><i class='fa-solid  fa-server'></i> server 2 <?php echo $system->validarLog($tamanoBdSecundarioL, 8) ?></div>
                ...
                <div class="row">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <tr>
                                <td >Tamaño BD</td>
                                <td><?php   if($tamanoBd==0) { echo $tamanoBd="<i class='fa-solid fa-check'></i>"; }else{  echo $tamanoBd . "GB";  } ?></td>
                                <td><?php   if($tamanoBdSec==0) { echo $tamanoBdSec="<i class='fa-solid fa-check'></i>"; }else{ echo $tamanoBdSec . "GB" ;  } ?></td>
                                <td><span><?php  if($tamanoBdSec==0) { echo $tamanoBdSec="<i class='fa-solid fa-check'></i>"; }else{ echo abs($tamanoBd - $tamanoBdSec) . " GB" ; }   ?></span></td>
                            </tr>
