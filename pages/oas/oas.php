  ...
  ?>
    ...
    <div class="col-md-6">
      <div class="card card-widget shadow widget-user">
        <div class="widget-user-header bg-info" style="height: 30%;">
          ...
          <h1 id="faenaName_<?php echo $faena['id_faena']; ?>" class="widget-user-username"><b><?php echo $faena["nombre_faena"]; ?></b></h1>
          <h6 id="updateTime_<?php echo $faena['id_faena']; ?>" class="widget-user-desc"><?php echo $system->datatimeCargaDiv(); ?></h6>
        </div>
              ...
              <div class="row">
                    ...
                    <div class="card-body">
                          ...
                          <div class="progress-group mt-2 px-2">
                            ...
                            <div class="progress progress-sm">
                              <div id="diskProgressBar_<?php echo $faena['id_faena']; ?>"
                                ...
                                aria-valuenow="<?php echo $miValor; ?>"
                                aria-valuemin="0"
                                aria-valuemax="100">
                              </div>
                            </div>
                            <div class="row d-flex justify-content-center">
                              <button type="button" class="btn btn-outline-dark d-flex my-2" data-toggle="modal" data-target="#particionesModal_<?php echo $faena['id_faena']; ?>">
                                Ver detalle
                              </button>
                            </div>
                          </div>
                          ...
                          <div class="progress-group mt-2 px-2">
                            ...
                            <div class="progress progress-sm">
                              <div id="ramProgressBar_<?php echo $faena['id_faena']; ?>"
                                class="progress-bar bg-primary"
                                role="progressbar"
                                style="width: <?php echo $ramPorcentaje; ?>%;"
                                aria-valuenow="<?php echo $ramPorcentaje; ?>"
                                aria-valuemin="0"
                                aria-valuemax="100">
                              </div>
                            </div>
                            <div class="row d-flex justify-content-center">
                              <button type="button" class="btn btn-outline-dark d-flex my-2" data-toggle="modal" data-target="#topCLecturaModal_<?php echo $faena['id_faena']; ?>">
                                Ver detalle
                              </button>
                            </div>
                          </div>
                      ...
                      <div class="row d-flex mt-3">
                        <div class="row d-flex align-items-center justify-content-center mx-auto">
                          ...
                          <h4 id="cpuLoadAverage_<?php echo $faena['id_faena']; ?>">
                    ...
                    <div class="card-footer" style="padding: 5px 0;">
                      <div class="row">
                        <div class="col-md-6 d-flex justify-content-center">
                          <p style="font-size: 20px;">Nom. Server
                  ...
                  <div class="card card-navy mt-3">
                    ...
                    <div class="card-body">
                      <div class="row d-flex align-items-stretch">
                        <!-- Servicio de Grafana -->
                        <?php
                        $rawGrafana = $faena['metricas']['Servicio de Grafana'] ?? "";
                        ...
                        <?php
                        $rawPostgres = $faena['metricas']['Servicio de PostgreSQL'] ?? "";
                        ...
                        <!-- Servicio de Rsyslog -->
                        <?php
                        $rawRsyslog = $faena['metricas']['Servicio Rsyslog'] ?? "";
                      ...
                      <div class="row d-flex align-items-stretch">
                        <!-- Servicio de SSH -->
                        <?php
                        $rawSSH = $faena['metricas']['Servicio SSH'] ?? "";
                        ...
                        <?php
                        $rawGvupload = $faena['metricas']['Servicio gvuploads'] ?? "";
                        ...
                        <?php
                        $rawMosquitto = $faena['metricas']['Servicio Mosquitto'] ?? "";
                      ...
                      <div class="row d-flex align-items-stretch">
                        <!-- Servicio de NTP -->
                        <?php
                        $rawNTP = $faena['metricas']['Servicio NTP'] ?? "";
                        ...
                        <?php
                        $rawVMTools = $faena['metricas']['Open VM Tools'] ?? "";
                        ...
                        <!-- Servicio de VPN -->
                        <?php
                        $rawVPN = $faena['metricas']['Servicio VPN'] ?? "";
                ...
                <div class="col-md-7">
                  ...
                  <div class="card card-navy">
                    ...
                    <div class="card-body">
                      <div class="row d-flex justify-content-center">
                        <i class="far fa-database fa-5x"></i> <!-- 2 veces el tamaño normal -->
                        <h4 id="tamanioDb_<?php echo $faena['id_faena']; ?>">
                          <?php echo ("Nombre db: " . $faena['metricas']['Nombre Db']) ?><br> <?php echo ($tamanioDbValue . $unidadDb)  ?>
                        </h4>

                        <table id="tablaMayorId_<?php echo $faena['id_faena']; ?>" class="table table-bordered" style="font-size: 1.7em;">
                          <thead>
                            <tr>
                      ...
                      <div class="collapse" id="extraDBContent_<?php echo $faena['id_faena']; ?>">
                        <div class="row d-flex justify-content-center mb-4">
                          <h3>Tablas más pesadas en la base de datos</h3>
                        </div>
                        <div class="row">
                          <div class="col-md-12">
                            <table id="topTablasMasPesadas_<?php echo $faena['id_faena']; ?>" class="table table-striped table-bordered" style="font-size: 1.7em;">
                              <thead>
                                <tr>
                                  <th>Esquema</th>
                                  <th>Tabla</th>
    ...
    <script>
      function initLoadAverageChart(canvasID, loadData) {
            ...
            scales: {
              xAxes: [{
                ...
                ticks: {
                  ...
                  fontColor: "#000000" // color de los números
              ...
              yAxes: [{
                ...
                ticks: {
                  ...
                  max: 5,
                  stepSize: 1,
                  padding: 10, // espacio entre número y eje
                  fontSize: 20,
                  fontColor: "#000000"
                  //fontStyle: "bold"
                }
        ...
        // Guardamos la instancia del gráfico para su posterior actualización
    ...
    ws.onmessage = function(event) {
      ...
      data.forEach(function(item) {
        ...
        if (tamanioDbElem && item.tamanioDbValue && item.unidadDb) {
          ...
          tamanioDbElem.innerHTML = nombreDb + "<br>" + item.tamanioDbValue + " " + item.unidadDb;
        }
