...
class alertas
{
    // Función para insertar una alerta en la base de datos
    function insertAlert($idFaena, $codigoAlerta, $mensajeAlerta, $eliminarAlerta = 0)
    {
        ...
        error_log(print_r($faenaDatos, true));

        
        
        // Obtén los datos de la alerta
        $alertaSistemaDatos = self::codigoAlerta(0, $codigoAlerta);
       
        if (!$alertaSistemaDatos instanceof mysqli) {
            return 0;
        }
        

        // Asegúrate de que el resultado es un objeto y luego se extraen los datos
        ...
        // Asegúrate de manejar el resultado correctamente
        if ($existeAlerta && $existeAlerta instanceof mysqli_result) {
    ...
    // Función para obtener los datos de una alerta en específico o de todas las alertas si el id es 0
    ...
    // Función para obtener las alertas de una faena en específico o de todas las faenas si el id es 0
    ...
    // Función para marcar una alerta como vista en la base de datos (cambiar el estado de vista a 1)
    ...
    // Función para marcar una alerta como solucionada en la base de datos (cambiar el estado a 0)
